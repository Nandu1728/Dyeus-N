...
function Bannner() {
  return (
    <div className='text-center p-4 Banner'><h1 className='information'>About Diana</h1>
    <h3 className='m-2 p-3 small-content'>A platform that looks out for you</h3>
    <p className=' p-1'>Diana empowers you to understand how your body works so you can look and feel your best </p>
    <hr></hr><h1 className='p-3 small-content2'>Our Philosophy
</h1><h3 className='small-content3'>Sustainable wellness<br></br> is a big-picture,<br></br> inside out approach</h3>
...
<FiPhoneCall size="0.5x" className='images'/>
